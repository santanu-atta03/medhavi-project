...
const MenuOption = ({setReviewModal}) => {
...
<button className="group relative inline-block w-[20px] p-[5px] h-[40px] m-[25px] md:hidden " onClick={toggleSidebar}>
  ...
  ></span>
      ...
      >
        ...
        <VideoDetailsSidebar setReviewModal={setReviewModal} closeSidebar={closeSidebar}/>
      </div>
    </>
  )
}
