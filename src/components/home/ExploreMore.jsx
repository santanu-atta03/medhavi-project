...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      <div className='lg:absolute gap-10 justify-center items-center lg:gap-0 flex lg:justify-between flex-wrap w-full md:w-[90%] lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-20 lg:px-0 px-3'>
        {
